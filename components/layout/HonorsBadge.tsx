...
export function HonorsBadge() {
  return (
    <div className="fixed top-1/2 right-0 -translate-y-1/2" style={{ zIndex: 'var(--z-badge)' }}>
      <div className="bg-dark text-inverse flex flex-col items-center gap-6 rounded-l-[var(--radius-badge)] px-3 py-5">
        <span className="font-display text-lg leading-none font-bold">W.</span>
